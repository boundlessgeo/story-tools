...
exports.styleStorageService = require('./style/styleStorageService');

},{"./style/SLDStyleConverter":2,"./style/StyleComplete":3,"./style/WFSDescribeFeatureType":4,"./style/WPSClassify":5,"./style/styleStorageService":6}],2:[function(require,module,exports){
//'use strict';
        ...
        createStroke: function(style, styleRule) {
            ...
            return {
                cssParameter: [{
                    ...
                    name: 'stroke-width',
                    content: (styleRule && styleRule.style.stroke.strokeWidth) ? [String(styleRule.style.stroke.strokeWidth)] : [String(style.stroke.strokeWidth)]
                }, {
                    name: 'stroke-opacity',
